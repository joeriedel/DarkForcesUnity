namespace CSharpSynth.Midi
{
    public class MidiEvent
    {
		...
		public MidiHelper.MidiSysExEvent midiSysExEvent;
        ...
        {
            return !isIMUSEEvent() && (midiChannelEvent == MidiHelper.MidiChannelEvent.None);
        }
        public bool isChannelEvent()
        {
			return !isIMUSEEvent() && (midiMetaEvent == MidiHelper.MidiMetaEvent.None);
        }
		public bool isIMUSEEvent() {
			return midiSysExEvent != MidiHelper.MidiSysExEvent.None;
		}
